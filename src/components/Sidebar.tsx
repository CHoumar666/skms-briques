...
const links: NavLink[] = [
  ...
  { href: "/ventes-du-jour", ownerOnly: true, label: "Ventes du jour", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
  ...
  { href: "/chiffre-affaires", label: "Chiffre d'affaires", icon: "M3 3v18h18M7 15l4-4 3 3 5-6" },
  { href: "/equipe", ownerOnly: true, label: "Équipe", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" },
];
  ...
  return (
    <aside className="w-64 shrink-0 bg-slate-900 text-slate-200 flex flex-col h-full min-h-screen print:hidden">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {links.filter((l) => !l.ownerOnly || role === "proprietaire").map((link) => {
      ...
      <div className="px-3 py-4 border-t border-slate-800">
        <p className="px-3 pb-2 text-xs text-slate-400">
          {username} · {role === "proprietaire" ? "Propriétaire" : "Personnel"}
        </p>
